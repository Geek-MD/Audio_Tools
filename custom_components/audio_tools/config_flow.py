"""Config flow for the Audio Tools integration."""
...
class AudioToolsConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):  # type: ignore[call-arg]
    """Handle a config flow for Audio Tools."""
